...
public class BlueConeDetectionUtil {
    ...
    public static Mat extractColors(final Mat src) {
        ...
        Scalar lowerBlue = new Scalar(100, 50, 40);
        Scalar upperBlue = new Scalar(130, 255, 200);
   ...
   public static void markOuterContour(final Mat processedImage,
       ...
       if (filteredContours.isEmpty()){
           AutoBlue.currentAction=State.RotateCone;
       } else{
           AutoBlue.currentAction=State.toCone;
       }
    // draw Contours
        for (MatOfPoint contour : filteredContours) {
            ...
            final Point center = new Point(rect.x + rect.width / 2, rect.y + rect.height / 2);
                ...
                AutoBlue.coneArea = Imgproc.contourArea(contour);
            }
